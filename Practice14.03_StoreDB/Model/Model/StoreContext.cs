        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>().HasData(
                new Order()
                {
                    ...
                    OrderDate = new DateTime(2019, 12, 01, 13, 56, 30),
                    RequiredDate = new DateTime(2020, 1, 1, 12, 23, 20),
                    ShippedDate = new DateTime(2019, 12, 19, 06, 10, 00),
                    StoreId = 1,
                    StaffId = 1
                },
                new Order()
                {
                    ...
                    OrderDate = new DateTime(2020, 3, 01, 13, 56, 30),
                    RequiredDate = new DateTime(2020, 4, 1, 15, 20, 30),
                    ShippedDate = new DateTime(2020, 3, 19, 4, 20, 00),
                    StoreId = 2,
                    StaffId = 2
                },
                new Order()
                {
                    ...
                    CustomerId = 1,
                    OrderStatus = "In Processing",
                    OrderDate = new DateTime(2019, 1, 03, 13, 56, 30),
                    RequiredDate = new DateTime(2020, 01, 29, 03, 10, 30),
                    ShippedDate = new DateTime(2020, 02, 02, 13, 56, 30),
                    StoreId = 2,
                    StaffId = 2
                },
                new Order()
                {
                    ...
                    OrderDate = new DateTime(2018, 3, 03, 18, 40, 00),
                    RequiredDate = new DateTime(2020, 4, 13, 13, 12, 00),
                    ShippedDate = new DateTime(2020, 6, 29, 11, 45, 30),
                    StoreId = 1,
                    StaffId = 1
                });
            #endregion
